...
class KemonoBaseCrawler(Crawler, is_abc=True):
    ...
    def ignore_content(self) -> bool:
        return self.manager.config_manager.settings.ignore_options.ignore_coomer_post_content

    @property
    def ignore_ads(self) -> bool:
        return self.manager.config_manager.settings.ignore_options.ignore_coomer_ads
    ...
    async def profile(self, scrape_item: ScrapeItem) -> None:
        ...
        if self.ignore_ads:
            ...
            self.log.info(f"filtering out all ad posts for {user}. This could take a while")
...
class KemonoCrawler(KemonoBaseCrawler):
    ...
    @property
    def session_cookie(self) -> str:
        return self.manager.config_manager.auth.kemono.session
