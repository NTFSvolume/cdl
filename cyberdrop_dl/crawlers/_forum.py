...
class MessageBoardCrawler(Crawler, is_abc=True):
    ...
    def scrape_single_forum_post(self) -> bool:
        return self.manager.config_manager.settings.download_options.scrape_single_forum_post

    @final
    @property
    def max_thread_depth(self) -> int:
        return self.manager.config_manager.settings.download_options.maximum_thread_depth

    @final
    @property
    def max_thread_folder_depth(self):
        return self.manager.config_manager.settings.download_options.maximum_thread_folder_depth
