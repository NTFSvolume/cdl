...
class LogManager:
    ...
    def from_manager(cls, manager: Manager) -> Self:
        files = LogFiles(
            main_log=manager.config_manager.settings.logs.main_log,
            last_post_log=manager.config_manager.settings.logs.last_forum_post,
            unsupported_urls_log=manager.config_manager.settings.logs.unsupported_urls,
            download_error_log=manager.config_manager.settings.logs.download_error_urls,
            scrape_error_log=manager.config_manager.settings.logs.scrape_error_urls,
        )
        return cls(files)
