...
def truncate_str(text: str, max_length: int) -> str:
...
def get_filename_and_ext(filename: str, forum: bool = False, mime_type: str | None = None) -> tuple[str, str]:
    ...
    filename_as_str = truncate_str(filename_as_path.stem, constants.MAX_NAME_LENGTHS["FILE"]) + filename_as_path.suffix
