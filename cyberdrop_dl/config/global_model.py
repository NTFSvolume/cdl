...
from cyberdrop_dl.config._common import ConfigGroup, Settings
...
class UIOptions(Settings):
    refresh_rate: PositiveInt = 10


class GenericCrawlerInstances(Settings):
...
class GlobalSettings(ConfigGroup):
